                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        {expenses.length > 0 && (
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-red-600 hover:text-red-700 hover:bg-red-50 border border-red-200 hover:border-red-300 font-bold text-sm transition-colors"
                            >
                                <Trash2 size={18} />
                                Eliminar gastos
                            </button>
                ...
                <>
                    ...
                    <PastelCard className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg max-h-[85vh] overflow-hidden flex flex-col z-[100] !shadow-2xl" noHover>
                        <div className="p-6 border-b border-pink-100">
                            <h3 className="text-xl font-bold text-gray-800">Eliminar gastos</h3>
                            <p className="text-sm text-gray-500 mt-1">Seleccioná los gastos a eliminar. Esta acción no se puede deshacer.</p>
                        </div>
                        <div className="p-4 overflow-y-auto flex-1 min-h-0">
                            ...
                            <div className="space-y-2">
                                {expenses.length === 0 ? (
                                    <p className="text-gray-400 text-sm py-4">No hay gastos con los filtros actuales.</p>
                                ) : (
                                    expenses.map(expense => (
                                        <label
                                            key={expense.id}
                                        ...
                                        >
                                            <input
                                                ...
                                                className="rounded border-pink-300 text-pink-600 focus:ring-pink-500"
                                            />
                                            <span className="flex-1 text-sm text-gray-800 truncate">{expense.description}</span>
