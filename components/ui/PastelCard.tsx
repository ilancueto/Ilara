    ...
    return (
        <div
            className={`
                ...
                rounded-[24px]
                shadow-[0_4px_24px_rgba(0,0,0,0.04),0_0_0_1px_rgba(0,0,0,0.02)]
                ${!noHover ? 'hover:shadow-[0_8px_32px_rgba(236,72,153,0.12)] hover:-translate-y-1 transition-all duration-300' : ''}
                ${className}
            `}
            {...props}
        >
