...
import type { Producto, ComboConItems } from '@/lib/supabase'
...
function getPrecioConDescuento(producto: Producto): number {
...
export function useCatalogDerivedLists({
    ...
    }, [productos, categoriaFiltro, busqueda, precioMin, precioMax, ordenamiento, ventasPorProducto])
