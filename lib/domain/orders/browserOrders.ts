...
const ORDER_SELECT =
  'id, order_number, status, channel, customer_id, customer_name, customer_phone, customer_email, notes, subtotal, discount_total, fulfillment_mode, shipping_quote_id, shipping_provider, shipping_carrier, shipping_carrier_description, shipping_service, shipping_service_description, shipping_delivery_estimate, shipping_amount, shipping_currency, shipping_destination_postal_code, shipping_destination_city, shipping_destination_state, shipping_destination_province_id, shipping_destination_locality_id, shipping_destination_street, shipping_destination_number, shipping_destination_formatted_address, shipping_destination_lat, shipping_destination_lon, total, coupon_code, coupon_discount_percentage, stock_reserved, created_at, updated_at, confirmed_at, completed_at, cancelled_at, cancel_reason'
