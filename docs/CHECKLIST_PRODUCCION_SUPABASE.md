...
3. Si nunca corriste scripts sueltos de la raíz del repo (`supabase_rls_all.sql`, `supabase_combos.sql`, etc.), revisá `docs/MIGRACIONES_SUPABASE.md` y aplicá lo que falte **una sola vez** antes o después de las migraciones, según dependencias.
